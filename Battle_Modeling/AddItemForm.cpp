	...
	: QDialog(parent)
{
	...
	setStyles();
	/*connect(ui.AddItemButton, &QPushButton::clicked, this, &AddItemForm::on_AddItemButton_clicked);
	connect(ui.ToMenu, &QPushButton::clicked, this, &AddItemForm::on_ToMenu_clicked);
	connect(ui.AddPowerCoef, &QPushButton::clicked, this, &AddItemForm::on_AddPowerCoef_clicked);
	connect(ui.DeleteItemButton, &QPushButton::clicked, this, &AddItemForm::on_DeleteItemButton_clicked);
	connect(ui.UnitTypes, &QListWidget::itemDoubleClicked, this, &AddItemForm::on_UnitTypes_itemDoubleClicked);
	connect(ui.ItemsListWidget, &QListWidget::itemDoubleClicked, this, &AddItemForm::on_ItemsListWidget_itemDoubleClicked);*/
}
...
void AddItemForm::on_AddItemButton_clicked() {
	...
	if (isToAdd) {
		writeCurItem();
		if (isContains) 
			delete ui.ItemsListWidget->takeItem(ui.ItemsListWidget->count() - 1);
	}
}
